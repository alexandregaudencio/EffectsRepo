...
{
    public class ColorfullMetaballRenderer2D : ScriptableRendererFeature
    {
        [System.Serializable]
        ...
        private ColorfullMetaballRender2DPass pass;

        public override void Create()
        {
            name = "Colorfull mestaballs 2D";

            pass = new ColorfullMetaballRender2DPass("Colorfull Metaballs2D")
            {
