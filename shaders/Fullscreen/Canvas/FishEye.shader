...
{
	float inv = 1-_Progress;
	float2 disp = _Size*(1-_Progress) * half2( cos( _Zoom * i.uv.x ), sin( _Zoom * i.uv.y ) );
	...
	return texTo * inv+ texFrom *_Progress;
}
