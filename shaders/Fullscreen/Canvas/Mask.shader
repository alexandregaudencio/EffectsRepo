...
Shader "Canvas/Mask"
{
	Properties
	{
		...
		_Progress( "Progress", Range(0, 1.0 ) ) = 0.0
		_Color( "Background Color", Color ) = ( 0, 0, 0, 1 )
		_Size("Size",Range(1,100)) = 25
	}
...
CGPROGRAM
	...
	v2f vert( appdata_img v )
	{
		...
		float tiling =  mapper( _Progress, 0, _Size);
	...
	{
	    fixed4 texColor = tex2D( _MainTex, i.uv )*_Progress;
